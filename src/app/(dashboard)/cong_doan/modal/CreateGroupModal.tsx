...
const CreateGroup: React.FC<{ onLoadingChange: (isLoading: boolean, progress: number) => void }> = ({ onLoadingChange }) => {
    ...
    return (
        <div className="p-4">
            ...
            <label className="block mb-2 font-medium text-gray-700">Founding Date</label>
            <Input
                type="date"
                value={founding_date}
