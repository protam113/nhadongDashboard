...
const NewsQueueList: React.FC = () => {
    ...
    const { queueData, isLoading, isError, handleBulkUpdate } = UserQueue(currentPage,"news", refreshKey);
    ...
    return (
        <div className="p-4">
            <h1 className='text-16 font-bold mt-4'>Quản lý hàng đợi duyệt tin tức</h1>
            <div className="p-4">
