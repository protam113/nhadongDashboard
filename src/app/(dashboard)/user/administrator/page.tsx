...
import {Table, Spin, Pagination, Button, message, Modal, Select, Alert} from "antd";
...
const ManageUsersPage: React.FC = () => {
    ...
    const columns = [
        { title: "ID", key: "id", render: (_: any, record: any, index: number) => index + 1 },
    ...
    return (
        <>
            ...
            <UserDrawer open={drawerOpen} onClose={closeDrawer} userInfo={selectedUser} />
            <Modal
                title="Xác nhận"
